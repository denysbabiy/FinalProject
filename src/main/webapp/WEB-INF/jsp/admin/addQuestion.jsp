...
<head>
    ...
    <script type='text/javascript'>
        ...
        function add_fields() {
            ...
            divtest.innerHTML = '<div id="' + answer + '"> <div class="label">Answer:</div><div class="content"><span>Text: <input class="form-control" type="text" name="answer-text" value="" required /> <button type="button" onclick="delete_fiels(' + answer + ')">Delete</button>' +
...
<form action="${pageContext.request.contextPath}/controller?command=addNewQuestion&quizId=${requestScope.quizId}"
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <input type="button" id="more_fields" onclick="add_fields();" value="Add answer"/>

            <div id="answer_fileds" class="login-form">
                <div>
                    <div class='label'>Answer:</div>
                    <div class="content">
                        <span>Text: <input class="form-control" type="text" name="answer-text" required
                                           value=""/></span>
